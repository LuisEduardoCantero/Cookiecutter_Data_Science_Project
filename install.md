# Cookiecutter_Final_Project guide installation
...
activate Cookiecutter_Final_Project
```
...
To move beyond notebook prototyping, all reusable code should go into the `cookiecutter_final_project/` folder package. To use that package inside your project, install the project's module in editable mode, so you can edit files in the `cookiecutter_final_project` folder and use the modules inside your notebooks :
...
```python
from cookiecutter_final_project.utils.paths import data_dir
data_dir()
```
